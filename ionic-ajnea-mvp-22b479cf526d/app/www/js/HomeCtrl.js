(function() {
  ...
  function HomeCtrl ($scope, $state, $translate,  UserService, PopupService, ActivityService, SettingService, UtilitiesService, $ionicSideMenuDelegate, BLE,Data, Settings) {
  ...
  HomeCtrl.$inject = ['$scope', '$state', '$translate',  'UserService', 'PopupService', 'ActivityService', 'SettingService', 'UtilitiesService', '$ionicSideMenuDelegate', 'BLE']
}());
