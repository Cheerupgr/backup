...
void setup(void)
{
 ...
 // Serial.println("Requesting Bluefruit info:");
  ...
  ble.info();
    ...
    if (! ble.sendCommandCheckOK(F("AT+GAPDEVNAME=VictoriseBLE")) ) {
...
if(timer.onRestart()) {
 ...
 if(minute==0) {pixel.setPixelColor(0, pixel.Color(0,255,0));minute++;}
else if(minute==1) {pixel.setPixelColor(0, pixel.Color(0,0,255));minute++;}
 else if(minute==2) {pixel.setPixelColor(0, pixel.Color(255,0,0));minute++;}
 else if(minute==3) {pixel.setPixelColor(0, pixel.Color(255,255,0)); minute++;}
 else if(minute==4) {pixel.setPixelColor(0, pixel.Color(0,255,255)); minute++;}
 else if(minute==5) {pixel.setPixelColor(0, pixel.Color(255,0,255)); minute= 0;}
